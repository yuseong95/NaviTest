                           ...
                           const std::string& tokenizer_path)
{
    ...
    __android_log_print(ANDROID_LOG_DEBUG, "ChatApp", "m_config_handle: %p", m_config_handle);
    __android_log_print(ANDROID_LOG_DEBUG, "ChatApp", "m_dialog_handle: %p", m_dialog_handle);
    if (m_config_handle == nullptr) {
        __android_log_print(ANDROID_LOG_ERROR, "ChatApp", "m_config_handle is null.");
    }
