...
class MainActivity : ComponentActivity() {
    ...
    private fun setupMapboxNavigation() {
        Log.d("MainActivity", "Setting up MapboxNavigation")

        // 1. RoutingTilesOptions 생성
        val routingTilesOptions = RoutingTilesOptions.Builder()
            .tileStore(mapInitializer.getTileStore())
            .build()
    ...
    private fun initializeManagers() {
        ...
        Log.d("MainActivity", "Managers initialized")
    }
    ...
    private fun initializeAfterPermissionGranted() {
        try {
            ...
            // MapboxNavigation 인스턴스 전달
            navigationManager.setMapboxNavigation(mapboxNavigation)
